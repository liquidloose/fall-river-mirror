...
class XAITextQuery:
    ...
    def get_response(
        ...
        Args:
            context (str): The system context/instructions to provide to the AI.
            message (str): The user's specific prompt or message.

        Returns:
            dict: AI-generated response fields including title, response, content.

        Raises:
            JSONResponse: Returns a 500 status code with error details on failure.
        """
