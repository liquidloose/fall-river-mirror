...
# Architecture Diagram Instructions for generate_diagram
...
1. Node IDs: camelCase, no spaces (`userService` not `user service`).
...
Pass `useArchitectureLayoutCode: "FIGMA_DIAGRAM_2026"` when calling generate_diagram to use the architecture layout.
